...
function strange_shape_surface($a, $b) {
    return rectangle_surface($a, $b) + (circle_surface($b) / 2);
}

function add_three_shapes_surface($a, $b, $r, $c, $d) {
    return rectangle_surface($a, $b) + circle_surface($r) + strange_shape_surface($c, $d);
}
