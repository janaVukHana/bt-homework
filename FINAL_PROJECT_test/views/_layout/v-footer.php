  ...
  <div class="container">
          <footer class="py-5">
            ...
            <div class="social-icons">
              <div class="social-icon mb-2"><a href="https://github.com/janaVukHana" target="_blank"><i class="fa-brands fa-github fa-3x"></i></a></div>
            ...
            <div class="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-top">
              <p>© 2022 Ilija Radovanović & ITBootcamp. All rights reserved. <br>Made with ♥ & ☕ in Novi Sad, Budva and Belgrade. </p>
