            ...
            <div class="col-lg-8">
                <!-- MAIN PRODUCT -->
                    ...
                    <div class="card">
                        <div class="row g-0">
                            <div class="col-8">
                                <img src=<?php echo htmlspecialchars($current_product['img']); ?> class="img-fluid rounded-start" alt="...">
                            </div>
                        
                            <div class="col-4">
                                <div class="card-body">
                                    <h5 class="card-title"><?php echo htmlspecialchars($current_product['title']); ?></h5>
                                    <p class="card-text">Price: <?php echo htmlspecialchars($current_product['price']); ?></p>
                                    <p class="card-text">Brand: <?php echo htmlspecialchars($current_product['brand']); ?></p>
                            ...
                            <div class="col-12 bg-dark text-light">
                                <p class="card-text p-3">Description: <?php echo htmlspecialchars($current_product['description']); ?></p>
                            </div>
                        </div> <!-- end of row -->
                    </div>
                <!-- END OF MAIN PRODUCT -->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-md-12 col-lg-7 bg-dark text-light">
                                        <div class="card-body">
                                            ...
                                            <a href="./single_product_page_controler.php?id=<?php echo htmlspecialchars($product['id']); ?>" class="btn btn-outline-success position-absolute bottom-0 end-0 mb-1 me-2">SHOW</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
